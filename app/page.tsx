	...
	return (
		<div className="px-10">
			...
			<div className="max-w-4xl mx-auto py-8">
				<h1 className="text-5xl font-bold">A time tracker without friction for Mac, iPhone and Apple Watch</h1>
			...
			<Image src="/screenshot.jpg" width="1280" height="720" alt="Screenshot" className="mx-auto py-5" />
